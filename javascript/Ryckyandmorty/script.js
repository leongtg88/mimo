...
/* en este codigo se hace nuestro primer FETCH donde se bajan los datos de una API  

  const charactersContainer = document.getElementById("characters-container");
  
fetch("https://rickandmortyapi.com/api/character").then(response.json()).then(data =>{
